...
namespace util
{
    namespace buffers
    {
        ...
        template <typename MutableBufferIterator, typename ConstBufferIterator>
        size_t buffers_copy(
            MutableBufferIterator idst, 
            MutableBufferIterator const & edst, 
            ConstBufferIterator isrc, 
            ConstBufferIterator const & esrc, 
        ...
        size_t buffers_copy(
            ...
            size_t src_off = 0)
        {
            return buffers_copy(dst.begin(), dst.end(), src.begin(), src.end(), size, dst_off, src_off);
        }
