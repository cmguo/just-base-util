// MineFieldConnection.h

#ifndef _UTIL_PROTOCOL_MINE_MINE_FIELD_CONNECTION_H_
#define _UTIL_PROTOCOL_MINE_MINE_FIELD_CONNECTION_H_
...
#endif // _UTIL_PROTOCOL_MINE_MINE_FIELD_CONNECTION_H_
