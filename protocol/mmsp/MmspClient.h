...
#ifndef _UTIL_PROTOCOL_MMSP_MMSP_CLIENT_H_
#define _UTIL_PROTOCOL_MMSP_MMSP_CLIENT_H_
...
namespace util
{
    namespace protocol
    {
        ...
        private:
            ...
            std::deque<MmspMessage> requests_;
            MmspMessage response_;
            MmspMessage proto_responses_;
            response_type resp_;
...
#endif // _UTIL_PROTOCOL_MMSP_MMSP_CLIENT_H_
